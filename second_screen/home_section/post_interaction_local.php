...
if(isset($_POST["post_vote_check_up"])){
...
if(isset($_POST["post_vote_check_up_final"])){
    $post_id = (int)$_POST["post_id"];
...
if(isset($_POST["post_vote_un_check_up"])){
...
if(isset($_POST["post_vote_check_down"])){
...
if(isset($_POST["post_vote_un_check_down_final"])){
...
if(isset($_POST["post_vote_un_check_down"])){
...
if(isset($_POST["post_click_check"])){
